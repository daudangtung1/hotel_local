    ...
    <div class="d-flex justify-content-end align-items-center mb-3">
        <div class="filter">
            <form action="{{route('reports.index')}}" class="d-flex" method="GET">
                <input type="text" name="s" id="s" class="form-control me-2" placeholder="Tìm kiếm theo phòng" value="@if(!empty(request()->s)){{request()->s}}@endif"  autocomplete="off">
                <select class="form-control me-2" name="services">
                ...
                <input type="text" class="form-control me-2 filter-date" placeholder="Ngày bắt đầu thuê" name="date" value="@if(!empty(request()->date)) {{request()->date}} @endif"  autocomplete="off">
