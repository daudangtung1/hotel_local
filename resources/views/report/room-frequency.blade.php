    ...
    <div class="d-flex justify-content-end align-items-center mb-3">
        <div class="filter">
            <form action="{{route('reports.index')}}" class="d-flex" method="GET">
                <input type="text" autocomplete="off"  class="form-control form-control-sm start-date me-2 filter-date-not-time" placeholder="{{__('Choose_start_date')}}" name="start_date" value="{{ $from_date }}"  autocomplete="off">
                <input type="text" autocomplete="off"  class="form-control form-control-sm end-date me-2 filter-date-not-time" placeholder="{{__('Chose_end_date')}}" name="end_date" value="{{ $to_date }}"  autocomplete="off">
