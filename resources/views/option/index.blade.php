                ...
                <div class="col-md-12">
                    <form class="row g-3" method="POST" action="{{route('options.update_all')}}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control form-control-sm form-control-sm" id="email" name="email"
                                   value="{{$option->email ?? ''}}">
                        </div>
                        <div class="col-md-12">
                            <label for="fax" class="form-label">Fax</label>
                            <input type="text" class="form-control form-control-sm form-control-sm" id="fax" name="fax"
                                   value="{{$option->fax ?? ''}}">
                        </div>
                        <div class="col-12">
