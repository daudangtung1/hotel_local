                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="filter">
                            <form action="{{route('customers.report')}}" class="d-flex" method="GET">
                                <input type="text" name="name" class="form-control form-control-sm me-2" placeholder="name" value="@if(!empty(request()->name)) {{request()->name}} @endif">
                                <input type="text" class="form-control form-control-sm me-2 filter-date" placeholder="CMND/HC" name="id_card" value="@if(!empty(request()->id_card)) {{request()->id_card}} @endif"  autocomplete="off">
