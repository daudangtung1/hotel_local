                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="filter">
                            <form action="{{route('customers.report')}}" class="d-flex" method="GET">
                                ...
                                <input type="text" class="form-control me-2 filter-date" placeholder="CMND/HC" name="id_card" value="@if(!empty(request()->id_card)) {{request()->id_card}} @endif"  autocomplete="off">
