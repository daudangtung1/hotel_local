                ...
                <div class="col-md-6">
                    <form class="row g-3" method="POST" action="@if(!empty($currentItem)){{route('services.update', ['service'=>$currentItem])}} @else{{route('services.store')}}@endif">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{$currentItem->name ??''}}" required>
                        </div>
                        <div class="col-md-12">
                            <label for="floor" class="form-label">Số lượng</label>
                            <input type="number" min="0" max="1000" class="form-control" name="stock" id="stock" value="{{$currentItem->stock ??'100'}}" required>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control" id="price" name="price" value="{{$currentItem->price ??'0'}}" required>
                        </div>
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary">@if(isset($currentItem)) Cập nhật @else Tạo mới @endif</buttonon>
                        </div>
                    </form>
                </div>
                <div class="col-md-6">
                    <table class="table table-bordered table-hover">
                        ...
                        @forelse($services as $key => $service)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-warning mr-2 d-inline-block" style="margin-right: 5px;" href="{{route('services.edit',['service' => $service])}}">
